    ...
    <View style={{ flex: 1, paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0 }}>
      ...
      {/* Home */}
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }} >
          <View><Image source={iconHome} style={{ width: 28, height: 28 }} /></View>
          <Text style={{ fontSize: 10, color: biru800, fontWeight:"bold" }}>Home</Text>
        </View>
      {/* Dietary */}
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center"}} >
          <View><Image source={iconHeartOutline} style={{ width: 28, height: 28 }} /></View>
          <Text style={{ fontSize: 10, color: biru800 }}>Dietary</Text>
        </View>
      {/* Consult */}
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }} >
          <View><Image source={iconConsultOutline} style={{ width: 28, height: 28 }} /></View>
          <Text style={{ fontSize: 10, color: biru800 }}>Consult</Text>
        </View>
      {/* Profile */}
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }} >
          <View><Image source={iconProfileOutline} style={{ width: 28, height: 28 }} /></View>
